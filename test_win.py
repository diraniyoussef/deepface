...
if __name__ == "__main__":
	...
	#DeepFace.play_with_annotations("https://youtu.be/wF-QnucySH4", "C:/Users/Dirani/ProgrammingProjects/DeepFace_Project/database/frames_info_2 seconds.pkl", source_type = "youtube", speed = "slow", fps = 30)
