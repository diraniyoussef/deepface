...
if __name__ == "__main__":
	...
	DeepFace.enhanced_stream(db_path = 'C:/Users/Dirani/ProgrammingProjects/DeepFace_Project/database', source = 'C:/Users/Dirani/ProgrammingProjects/DeepFace_Project/make a video/trial2.mp4', model_name = "DeepFace", actions = [], distance_metric = 'euclidean', number_of_processes = 2, auto_add = True) #distance_metric = 'euclidean'
